...
BOOKS = {
    ...
    "coaches-guide-exemplary-leaders": ("A Coach's Guide to Developing Exemplary Leaders", "Kouzes, Posner & Biech", "Leadership & Coaching", "atlas"),
    "year-with-peter-drucker": ("A Year with Peter Drucker", "Joseph A. Maciariello", "Leadership & Coaching", "atlas"),
    "clean-coaching": ("Clean Coaching", "Angela Dunbar", "Leadership & Coaching", "atlas"),
    "good-leaders-ask-great-questions": ("Good Leaders Ask Great Questions", "John C. Maxwell", "Leadership & Coaching", "atlas"),
    "hbr-leadership": ("HBR's 10 Must Reads on Leadership", "Harvard Business Review (anthology)", "Leadership & Coaching", "atlas"),
    "how-great-leaders-think": ("How Great Leaders Think: The Art of Reframing", "Lee Bolman & Terrence Deal", "Leadership & Coaching", "atlas"),
    "leadership-in-organizations": ("Leadership in Organizations", "Gary Yukl", "Leadership & Coaching", "atlas"),
    "managing-virtual-teams": ("Managing Virtual Teams", "Brown, Huettner & James-Tanny", "Leadership & Coaching", "atlas"),
    "motivate-like-a-ceo": ("Motivate Like a CEO", "Suzanne Bates", "Leadership & Coaching", "atlas"),
    "action-learning": ("Optimizing the Power of Action Learning", "Michael J. Marquardt", "Leadership & Coaching", "atlas"),
    "overcoming-five-dysfunctions": ("Overcoming the Five Dysfunctions of a Team: A Field Guide", "Patrick Lencioni", "Leadership & Coaching", "atlas"),
    "paid-to-think": ("Paid to Think", "David Goldsmith", "Leadership & Coaching", "atlas"),
    "the-carpenter": ("The Carpenter", "Jon Gordon", "Leadership & Coaching", "atlas"),
    "leadership-journey": ("The Leadership Journey", "Gary Burnison", "Leadership & Coaching", "atlas"),
    "think-entrepreneur-act-ceo": ("Think Like an Entrepreneur, Act Like a CEO", "Beverly E. Jones", "Leadership & Coaching", "atlas"),
    "10x-rule": ("The 10X Rule", "Grant Cardone", "Psychology & Self-Development", "atlas"),
    "factory-of-one": ("A Factory of One", "Daniel Markovitz", "Psychology & Self-Development", "atlas"),
    "awaken-the-giant-within": ("Awaken the Giant Within", "Tony Robbins", "Psychology & Self-Development", "atlas"),
    "boundaries": ("Boundaries", "Henry Cloud & John Townsend", "Psychology & Self-Development", "atlas"),
    "clarity": ("Clarity: Clear Mind, Better Performance, Bigger Results", "Jamie Smart", "Psychology & Self-Development", "atlas"),
    "confidence-meadows": ("Confidence: How to Overcome Your Limiting Beliefs", "Martin Meadows", "Psychology & Self-Development", "atlas"),
    "daily-self-discipline": ("Daily Self-Discipline", "Martin Meadows", "Psychology & Self-Development", "atlas"),
    "do-more-great-work": ("Do More Great Work", "Michael Bungay Stanier", "Psychology & Self-Development", "atlas"),
    "dont-shoot-the-dog": ("Don't Shoot the Dog", "Karen Pryor", "Psychology & Self-Development", "atlas"),
    "breaking-the-habit-of-being-yourself": ("Breaking the Habit of Being Yourself", "Joe Dispenza", "Psychology & Self-Development", "atlas"),
    "emotional-agility": ("Emotional Agility", "Susan David", "Psychology & Self-Development", "atlas"),
    "emotional-intelligence-2-0": ("Emotional Intelligence 2.0", "Travis Bradberry & Jean Greaves", "Psychology & Self-Development", "atlas"),
